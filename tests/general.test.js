...
describe('Validator functionality', () => {
  test('Should successfully extract a mix of all params', () => {
    morx.registerFilter('convertPercentage', (value) => (value * 1) / 100);
    morx.registerValidator('lessThan', (value, max) => (value * 1) < max);
    morx.registerValidator('isWithin', (value, max, min) => ((value * 1) < max) && ((value * 1) > min));
