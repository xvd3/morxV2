...
function MorxV2() {
  ...
  const customFilters = {};
  let ExtractorErrorClass = Error;
  let errorThrower = null;

  function errorThrowerDefault(message) {
    throw new ExtractorErrorClass(message);
  }
  errorThrower = errorThrowerDefault;
          ...
          if (!typeOfParamValueFlag) {
            ...
            if (!spec.notParam) {
              if (!spec.map) {
                ...
                extractedParams[spec.map] = paramValue;
              }
            } else {
  ...
  function setCustomErrorClass(CustomErrorClass) {
    ExtractorErrorClass = CustomErrorClass;
  }

  function setErrorThrowerFunction(errorThrowerFunc) {
    errorThrower = errorThrowerFunc;
  }

  function getCustom() {
    return ExtractorErrorClass;
  }

  function getErrorThrower() {
    return errorThrower;
  }
  ...
  return {
    ...
    processParams,
    setCustomErrorClass,
    setErrorThrowerFunction,
    getErrorThrower,
  };
}

module.exports = MorxV2;
